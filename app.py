...
def run():
    ...
    if add_selectbox == 'Online':
        ...
        GDP_per_Capita = st.slider('Log of GDP_per_Capita', min_value=0.00, max_value=2.30, value=0.97)
        # GDP_per_Capita = st.number_input('Log of GDP_per_Capita', min_value=0.00, max_value=2.30, value=0.97)
        Social_Support = st.slider('Annual Avg of Social_Support', min_value=0.00, max_value=1.74, value=1.03)
        Healthy_Life_Expectancy = st.slider('Healthy Life Expectancy', min_value=0.00, max_value=1.24,
                                                  value=0.60)
        Freedom = st.slider('Annual Avg of Freedom', min_value=0.00, max_value=0.84, value=0.44)
        ...
        Generosity = st.slider('Annual Avg of Generosity', min_value=0.00, max_value=0.93, value=0.20)
